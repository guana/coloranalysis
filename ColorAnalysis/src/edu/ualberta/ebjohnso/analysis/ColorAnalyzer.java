...
public class ColorAnalyzer {
	...
	private void displayImage(Image imageP, int heightP, int widthP, int locX, int locY, String title){
		//Display display = new Display(imageP, heightP, widthP, locX, locY, title);
	}
